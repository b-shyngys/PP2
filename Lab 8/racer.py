...
def handle_crash():
    global SPEED, SCORE, COINS, c1, c2, c3, c4, c5  # Declare all global variables at the top
    screen.fill(RED)
    game_over_text = font.render("Game Over!", True, BLACK)
    coins_collected_text = font.render(f"Coins Collected: {COINS}", True, BLACK)
    restart_text = font_small.render("Tap any button to restart", True, BLACK)

    screen.blit(game_over_text, (100, 200))
    screen.blit(coins_collected_text, (100, 250))
